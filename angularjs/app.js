...
var app = angular.module('app', ['ui.router', 'ngSanitize', 'satellizer',
	'toastr', 'ngAnimate', 'ngDisqus', 'bw.paging', 'cp.ngConfirm', 'summernote', 'ui.tinymce',
	'slick'
]);
...
app.config(function ($stateProvider, $urlRouterProvider, $authProvider, $locationProvider, $disqusProvider, config) {
	...
	$urlRouterProvider.otherwise('/board/home?main_menu=home');
	...
	$stateProvider
		...
		.state('board.home', {
			url: '/home',
			templateUrl: 'pages/board/home.html',
			controller: 'board.home.ctrl as vm',
		})
		.state('board.list', {
			url: '/list',
